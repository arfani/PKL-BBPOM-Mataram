...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $text = '<div style="text-align: justify;">Selamat Pengajuan PKL Anda di BPOM Mataram sudah diterima.<br>Silakan mengunjungi dashboard PKL berikut untuk informasi lengkapnya.</div><div class="text-center mt-1"><a href="dashboardpkl.php" style="font-size: 12px; padding: 4px 7px; margin: 0px; background-color: #007bff; color: white; text-decoration: none; border-radius: 5px;">Dashboard PKL</a></div>';
