...
<head>
    ...
    /* Mengatur modal agar memiliki padding dan jarak antar elemen yang lebih baik */
    .modal-content {
        border-radius: 10px;
    ...
    /* Mengatur judul modal dengan gaya yang lebih menonjol */
    .modal-header {
        border-bottom: none;
    }
    ...
    <div class="container my-2">
        ...
        <div class="download-container mt-3">
            ...
            <div class="download-box" style="border-color: #17a2b8;">
                ...
                <h3>Absensi</h3>
                <a href="path/to/Absensi.docx" download style="background-color: #17a2b8;">Download</a>
            </div>
        </div>
    </div>
